...
This script will run the descriptive statistics for all of the trust variables within the ESS dataset. 
This dataset can take some time to run as we apply weightings throughout and are looping over each wave and country of data. 

When doing international comparisons, we primarily use unweighted data to make comparison faster, then use weighted data later for the final values. Weights are applied in all calculations for the UK only. 
