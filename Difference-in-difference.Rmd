...
### Call exisitng scripts to get data and code. 
...
#### Compare via matching algorithm. 

With Euclidian matching, it also finds that Germany is the best comparison group. When matched on data from R1 to R7 (pre-Referendum):
...
### Robustness check - against period t-1 (R6)
