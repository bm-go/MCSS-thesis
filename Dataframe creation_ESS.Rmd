...
Read the dataset (my one has most repeated variables for waves 1 to 11) for all relevant countries

```{r}
ess_data <- haven::read_sav(here("Data/ESS_large/ESS_large_w1_11.sav"))
